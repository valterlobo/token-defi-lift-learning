...
describe('Token WolftTokenLock', () => {
  ...
  describe('Transactions LOCK', () => {
    it("Should fail if sender doesn't owner tokens | LOCK: 1672531201", async () => {
      //
      ...
      const bl = await hardhatTokenLock.balanceOf(addr1.address);
      // console.log(bl);
